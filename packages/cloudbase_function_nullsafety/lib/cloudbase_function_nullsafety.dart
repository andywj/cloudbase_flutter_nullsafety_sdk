...
class CloudBaseFunction {
  ...
  Future<CloudBaseResponse> callFunctionWithoutAuth(String name,
      [Map<String, dynamic>? params]) async {
    if (name.isEmpty) {
      throw new CloudBaseException(
          code: CloudBaseExceptionCode.EMPTY_PARAM,
    ...
    CloudBaseResponse res =
        await cloudbaseRequest.postWithoutAuth(_action, callParams);
    res = CloudBaseResponse.fromMap(res.data);
