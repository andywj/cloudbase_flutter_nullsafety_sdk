...
import 'package:cloudbase_database_nullsafety/src/command/logic.dart';
import 'package:cloudbase_database_nullsafety/src/command/query.dart';
import 'package:cloudbase_database_nullsafety/src/command/update.dart';
...
class Command {
  ...
  geoWithin(geometry) {
    ...
    return this
        ._queryOP(QueryCommandsLiteral.GEO_WITHIN, {'geometry': geometry});
  }
  ...
  geoIntersects(geometry) {
    ...
    return this
        ._queryOP(QueryCommandsLiteral.GEO_INTERSECTS, {'geometry': geometry});
  }
